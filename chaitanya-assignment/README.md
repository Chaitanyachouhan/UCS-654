...
**1000 simulation runs** were executed (seeded with Roll Number `102316106`) to generate a diverse dataset. Each run recorded the **average waiting time** as the target variable.

The dataset was saved as:  
📄 `simulation_data_102316106.csv`
...
### R² Score Comparison
![R2 Score Comparison](mae_plot_102316106%20(1)-c1.png)

### MSE Comparison
![MSE Comparison](mse_plot_102316106%20(1)-c1.png)

### RMSE Comparison
![RMSE Comparison](rmse_plot_102316106%20(1)-c1.png)

### MAE Comparison
![MAE Comparison](r2_plot_102316106%20(1)-c1.png)
...
| File | Description |
|---|---|
| `simulation_data_102316106.csv` | Raw simulation data (1000 runs) |
| `r2_plot_102316106.png` | R² Score bar chart |
| `mse_plot_102316106.png` | MSE bar chart |
| `rmse_plot_102316106.png` | RMSE bar chart |
| `mae_plot_102316106.png` | MAE bar chart |
